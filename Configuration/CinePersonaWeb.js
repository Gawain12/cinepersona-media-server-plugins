(function () {
    ...
    function ensureStyles() {
        ...
        style.textContent = "" +
            ...
            "@media (max-width:560px){.cinepersona-detail-button{padding:.5em .8em}.cinepersona-review-card{padding:21px;border-radius:15px}.cinepersona-review-stars{gap:0}.cinepersona-review-star{font-size:24px}}";
    ...
    function openModal() {
        ...
        var copy = makeElement("p", "cinepersona-review-copy", "评分会保存到 Emby 和 CinePersona，短评同步到 CinePersona。");
